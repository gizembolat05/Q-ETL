...
def generate_tip3_edw_code(script_name, sql_query, source_db_name, target_db_name, source_table_name, target_table_name, schema="dbo", subject_area="MsyDWH", date_column="DayId"):
    """
        date_column: Partition'lama için kullanılacak tarih sütunu (varsayılan: "DayId")
    """
