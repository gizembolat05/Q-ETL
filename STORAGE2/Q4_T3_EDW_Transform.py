...
def generate_tip3_edw_code(script_name, sql_query, source_db_name, target_db_name, source_table_name, target_table_name,table_description, data_type=3, schema="dbo", subject_area="MSYDWH"):
